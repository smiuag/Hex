...
export const RESEARCH_COST = {
  ...
  SHIPENGINEERING: { CRYSTAL: 30000, METAL: 20000, ENERGY: 5000 },
...
export const RESEARCH_REQUIRED_BUILDING: Record<ResearchType, ResearchRequiredBuilding> = {
  ...
  GRAVITY: [
    { buildingLevelRequired: 1, buildingType: "ALIEN_LAB", researchLevel: 1 },
    { buildingLevelRequired: 2, buildingType: "ALIEN_LAB", researchLevel: 2 },
  ],
