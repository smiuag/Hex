...
> = {
  ...
  EMBASSY: {
    baseBuildTime: BUILDING_TIME.EMBASSY,
    image: IMAGES.BUILDING_EMBASSY,
    imageBackground: IMAGES.EMBASSY_BACKGROUND,
    underConstructionImage: IMAGES.BUILDING_UNDER_CONSTRUCTION,
    baseCost: BUILDING_COST.EMBASSY,
    production: BUILDING_PRODUCTION.EMBASSY,
    requiredResearch: BUILDING_REQUIRED_RESEARCH.EMBASSY,
    maxNumberInPlanet: BUILDING_MAX_IN_PLANET.EMBASSY,
    maxLvl: BUILDING_MAX_LVL.EMBASSY,
    order: 7,
    special: true,
  },
  HANGAR: {
