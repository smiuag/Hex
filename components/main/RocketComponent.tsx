...
import CustomShipDesigner from "../auxiliar/CustomShipDesigner";
...
export default function RocketComponent() {
  ...
  return isMaxed ? (
    <>
      <HeaderClose title={tBuilding("buildingName.ROCKET")} onClose={onClose} />
      <View style={{ flex: 1 }}>
        <CustomShipDesigner></CustomShipDesigner>
      </View>
    </>
  ) : (
    <View style={{ flex: 1 }}>
